var width =(1050),  // to change width and height please change size here
    height = Math.max(750);
  ...
  /*  g.append('path')
    ...
    map.append("g")
        ...
        .on('mouseover', function (d) {
            ...
            d3.select(".rank")
                .text(d.details && d.details.rank && "Confirmed Cases Per Million People: " + d.details.rank || "No data found");

            d3.select(".silvermedal")
                .text(d.details && d.details.silvermedal ? `Share of Fully Vaccinated People : ${ d.details.silvermedal}%`:"No data found");

            d3.select(".goldmedal")
                .text(d.details && d.details.goldmedal && "Confirmed Deaths Per Million People: " + d.details.goldmedal || "No data found");
